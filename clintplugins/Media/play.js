...
module.exports = {
    ...
    run: async (context) => {
        ...
        if (!text || text.trim() === '') {
            return m.reply(`◈━━━━━━━━━━━━━━━━◈\n❒ Yo, ${m.pushName}, give me a YouTube URL! Example: .play https://www.youtube.com/watch?v=1-xGerv5FOk\n◈━━━━━━━━━━━━━━━━◈`);
        }

        // Validate YouTube URL
        const urlPattern = /(https?:\/\/)?(www\.)?(youtube\.com|youtu\.be)\/.+/;
        if (!urlPattern.test(text.trim())) {
            return m.reply(`◈━━━━━━━━━━━━━━━━◈\n❒ That’s not a valid YouTube URL, ${m.pushName}! Try something like https://www.youtube.com/watch?v=1-xGerv5FOk\n◈━━━━━━━━━━━━━━━━◈`);
        }

        try {
            await m.reply(`◈━━━━━━━━━━━━━━━━◈\n❒ A moment, Toxic-MD is downloading your audio...\n◈━━━━━━━━━━━━━━━━◈`);
            ...
            if (!downloadData || !downloadData.status || !downloadData.result || !downloadData.result.download_url) {
                return m.reply(`◈━━━━━━━━━━━━━━━━◈\n❒ Couldn’t download the audio, ${m.pushName}. Invalid URL or API’s acting up. Check the link and try again!\n◈━━━━━━━━━━━━━━━━◈`);
            }
            ...
            if (downloadData.result.duration) {
                ...
                const seconds = durationParts.length === 3
                    ...
                    : durationParts.length === 2
                        ...
                        : durationParts[0];
                if (seconds > 300) {
                    return m.reply(`◈━━━━━━━━━━━━━━━━◈\n❒ Audio "${downloadData.result.title}" is too long (${downloadData.result.duration}), ${m.pushName}. Pick a shorter one (under 5 minutes)!\n◈━━━━━━━━━━━━━━━━◈`);
                }
            }
            ...
            await m.reply(`◈━━━━━━━━━━━━━━━━◈\n❒ Oops, ${m.pushName}! Couldn’t download the audio for "${text}". API’s down or the link’s busted. Try another URL.\n❒ Check https://github.com/xhclintohn/Toxic-MD for help.\n◈━━━━━━━━━━━━━━━━◈`);
        }
    }
};