        ...
        const sections = [
            {
                ...
                highlight_label: '',
                rows: [
                    { header: 'Full Menu', title: 'FullMenu', description: 'All commands list', id: '/fullmenu' },
                    { header: 'Dev', title: 'Dev', description: 'Developer contact', id: '/dev' },
                    { header: 'Report', title: 'Report', description: 'Report a bug to dev', id: '/report' },
                ],
            },
            {
                title: 'ℹ Bot Info',
                ...
                rows: [
                    ...
                    { header: 'Settings', title: 'Settings', description: 'Bot settings', id: '/settings' },
                    { header: 'Mode', title: 'Mode', description: 'Toggle bot mode', id: '/mode' },
                ],
            },
            {
                ...
                highlight_label: '',
                rows: [
                    { header: 'GeneralMenu', title: 'GeneralMenu', description: 'General commands', id: '/generalmenu' },
                    { header: 'SettingsMenu', title: 'SettingsMenu', description: 'Settings commands', id: '/settingsmenu' },
                    { header: 'OwnerMenu', title: 'OwnerMenu', description: 'Owner-only commands', id: '/ownermenu' },
                    { header: 'GroupMenu', title: 'GroupMenu', description: 'Group management', id: '/groupmenu' },
                    { header: 'AIMenu', title: 'AIMenu', description: 'AI-powered commands', id: '/aimenu' },
                    { header: 'DownloadMenu', title: 'DownloadMenu', description: 'Download commands', id: '/downloadmenu' },
                    { header: 'EditingMenu', title: 'EditingMenu', description: 'Image/video editing', id: '/editingmenu' },
                    { header: 'EffectsMenu', title: 'EffectsMenu', description: 'Text effect commands', id: '/effectsmenu' },
                    { header: 'AnimeMenu', title: 'AnimeMenu', description: 'Anime image commands', id: '/animemenu' },
                    { header: 'UtilsMenu', title: 'UtilsMenu', description: 'Utility tools', id: '/utilsmenu' },
                    { header: 'ReactionsMenu', title: 'ReactionsMenu', description: 'Reaction commands', id: '/reactionsmenu' },
                    { header: 'PrivacyMenu', title: 'PrivacyMenu', description: 'Privacy settings', id: '/privacymenu' },
                ],
            },
        ];
