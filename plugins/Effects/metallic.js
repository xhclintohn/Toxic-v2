...
module.exports = {
    name: 'metallic',
    alias: ['metal', 'metallictext'],
    description: 'Generate 3D metallic text effect',
    run: async (context) => {
        ...
        try {
            ...
            const result = await mumaker.ephoto('https://en.ephoto360.com/impressive-decorative-3d-metal-text-effect-798.html', text.trim());
            await client.sendMessage(m.chat, { react: { text: '✅', key: m.key } });
