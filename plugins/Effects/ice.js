...
module.exports = {
    name: 'ice',
    alias: ['icetext', 'icelogo'],
    description: 'Generate ice text effect',
    run: async (context) => {
        ...
        try {
            ...
            const result = await mumaker.ephoto('https://en.ephoto360.com/ice-text-effect-online-101.html', text.trim());
            await client.sendMessage(m.chat, { react: { text: '✅', key: m.key } });
