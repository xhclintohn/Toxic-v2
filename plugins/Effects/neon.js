...
module.exports = {
    ...
    description: 'Generate neon light text effect',
    run: async (context) => {
        ...
        try {
            ...
            const result = await mumaker.ephoto('https://en.ephoto360.com/create-colorful-neon-light-text-effects-online-797.html', text.trim());
            await client.sendMessage(m.chat, { react: { text: '✅', key: m.key } });
